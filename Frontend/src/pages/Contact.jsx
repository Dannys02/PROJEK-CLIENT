    ...
    return (
        <section id="contact" className="py-16 bg-white">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-4">Hubungi Saya</h2>
                    ...
                    <div className="md:w-1/2">
                        <div className="bg-indigo-50 rounded-xl p-8 h-full">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Dannys@example.com</p>
                                    </div>
                                </div>
                            ...
                            <div className="mt-8 pt-6 border-t border-indigo-100">
                                <h4 className="font-medium text-gray-800 mb-4">Ikuti Saya</h4>
                                <div className="flex space-x-4">
                                    {['LinkedIn', 'GitHub', 'Instagram', 'Twitter'].map((social) => (
                                        <a
                                            key={social}
                                            href="#"
                                            className="bg-white p-3 rounded-lg text-gray-600 hover:text-indigo-600 hover:shadow-md transition-all duration-300"
                                        >
